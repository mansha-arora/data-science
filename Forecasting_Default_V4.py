...
#Lets Go one by One # Bivariate Analysis
...
"""
Durationinmonth_PCT=ps.sqldf(query_pct, locals())
...
"""
Credithistory_PCT=ps.sqldf(query_pct, locals())
...
order by Purpose
"""
Purpose_PCT=ps.sqldf(query_pct, locals())
...
"""
Savingsaccount_bonds_PCT=ps.sqldf(query_pct, locals())
...
"""
Presentemploymentsince_PCT=ps.sqldf(query_pct, locals())
...
"""
Personalstatusandsex_PCT=ps.sqldf(query_pct, locals())
...
order by Guarantors
"""
Guarantors_PCT=ps.sqldf(query_pct, locals())
...
"""
Presentresidencesince_PCT=ps.sqldf(query_pct, locals())
...
order by Property
"""
Property_PCT=ps.sqldf(query_pct, locals())
